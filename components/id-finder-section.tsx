    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="group relative mx-auto max-w-3xl">
          {/* Card glow effect */}
          <div
            className="pointer-events-none absolute -inset-0.5 rounded-2xl bg-gradient-to-r from-accent/20 via-primary/20 to-accent/20 opacity-0 blur transition-all duration-500 group-hover:opacity-100"
            aria-hidden="true"
          />
            ...
            <form onSubmit={handleSearch} className="relative">
              <div className="flex flex-col gap-4 sm:flex-row">
                ...
                >
                  ...
                  <div
                    className="pointer-events-none absolute inset-0 translate-x-[-100%] bg-gradient-to-r from-transparent via-white/20 to-transparent transition-transform duration-1000 group-hover/btn:translate-x-[100%]"
                    aria-hidden="true"
                  />
            ...
            {result.found ? (
              <div className="space-y-4">
                ...
                {result.data.map((member, index) => (
                  <div
                    ...
                    className="group relative overflow-hidden rounded-2xl border border-border/50 bg-gradient-to-br from-card/90 to-card/50 backdrop-blur-sm shadow-xl"
                  >
                    {/* Success glow */}
                    <div
                    ...
                    {/* Animated border */}
                    <div
                      className="absolute inset-0 rounded-2xl bg-gradient-to-r from-accent/40 via-primary/40 to-accent/40 opacity-0 blur transition-opacity duration-500 group-hover:opacity-100"
                      aria-hidden="true"
                    />
              ...
              <div className="rounded-2xl border border-border/50 bg-card/50 backdrop-blur-sm p-8 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  {result.message ||
                    "No guild member found with that search. Please check and try again."}
                </p>
              </div>
            )}
          </div>
